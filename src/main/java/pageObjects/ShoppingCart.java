...
public class ShoppingCart extends BasePage {                      //Extends BasePage for parallel execution

    public WebDriver driver;

    public ShoppingCart() throws IOException {             //public ShoppingCart(WebDriver driver)  was changed for parallel execution
    ...
    By promoAddBtn = By.xpath("//button/span[contains(text(), 'Add')]");   //On the course he wrote -form[method='post']  span- locator but it has 4 matching elements
