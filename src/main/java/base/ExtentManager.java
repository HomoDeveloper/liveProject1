...
public class ExtentManager extends BasePage{
    ...
    public static ExtentReports setupExtentReport(String testName){
        ...
        ExtentSparkReporter spark = new ExtentSparkReporter(System.getProperty("user.dir") + "\\reports\\" + extentReportPrefixName(testName) + ".html");
        extentReport.attachReporter(spark);
        extentReport.setSystemInfo("Tester", "Vasilis");
    ...
    public static String extentReportPrefixName(String testName){
    ...
    public synchronized static void attachImage(){
        getTest().addScreenCaptureFromPath(getScreenDestinationPath());
    }
